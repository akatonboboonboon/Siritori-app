"""Build the nine legacy reviewed-seed theme CSV files.

These files are build-time compatibility inputs, not the runtime theme map.
The 16-theme runtime map is generated by ``scripts.build_bot_data``.
