...
3. 未収録語を申請し、自分の一覧だけに残ること、再デプロイ後も残ること、
   申請直後には対局で使用できないことを確認する
4. 関連コードとこの記録を読み、保存するもの・保存しないものの理由を本人の言葉で説明する

申請を承認・不採用にする運用画面と、承認語を固定辞書へ取り込むデータ更新は別の
人手レビュー工程です。今回の公開機能は、申請だけで判定辞書を変更しません。
