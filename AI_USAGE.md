...
| 2026-07-24 | OpenAI Codex | ソロBot戦・テーマ | ソロ戦を対局と同じ厳密な`Game`スナップショットで保存・一時停止・再開し、Normal／Hard Botとサーバー側テーマ制約を実装した | AI担当完了・最終統合中 | 応募者本人がEasy Bot、設定画面、タイマー表示を実装・確認する | 最終Draft PRへ追記予定 |
